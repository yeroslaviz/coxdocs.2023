...
-   \[\[:maxquant:common:Bug reporting\]\] \<ifauth @internal\> These pages are only visible to internal users:
-   \[\[:maxquant:common:internal:Glossary\]\]
-   \[\[:maxquant:internal:FAQ\]\]
-   \[\[:maxquant:internal:background\]\] (how it works under the hood) </ifauth>
...
Cox, J. and Mann, M. [MaxQuant enables high peptide identification rates, individualized p.p.b.-range mass accuracies and proteome-wide protein quantification.](http://www.nature.com/nbt/journal/v26/n12/full/nbt.1511.html) //Nat Biotechnol//, 2008, 26, pp 1367-72. \\ **Note that the paper has a large supplement containing in-depth descriptions of algorithms.**
...
Tyanova, S., Temu, T., and Cox, J., [The MaxQuant computational platform for mass spectrometry-based shotgun proteomics](https://www.nature.com/articles/nprot.2016.136), //Nat Protocols//, 2016, 11, pp 2301--2319 \\ **Note that this paper explains how to run MaxQuant in detail.**
